...
<!--
![NoteHub Banner](./screenshots/banner.png) Add your banner image -->
...
![Homepage Screenshot](./public/screenshots/homepage.png) <!-- Add your screenshot -->
...
- view all the Articles in Card Form
  ![View Article](./public/screenshots/articles.png) <!-- Add your screenshot -->
...
- Submit to save
  ![Create Article](./public/screenshots/new-article.png) <!-- Add your screenshot -->

3. **Edit Article:**
   ![Edit Article](./public/screenshots/edit-article.png) <!-- Add your screenshot -->
...
4. **View Single Article:**
   ![Edit Article](./public/screenshots/view-article.png) <!-- Add your screenshot -->
...
5. **Delete Article:**
   ![Delete Article](./public/screenshots/delete-article.png) <!-- Add your screenshot -->

   - In edit mode, click the red Delete button
   - Confirm deletion in the dialog

6. **Faq:**
   ![Faq About Website](./public/screenshots/faq.png) <!-- Add your screenshot -->
