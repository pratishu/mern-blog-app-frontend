      ...
      <div className="px-4">
        <div className="flex justify-end py-2">
          <Link
            ...
            className="px-4 py-2 text-gray-50 font-medium bg-blue-400 rounded-lg hover:bg-slate-300 hover:text-blue-500 outline-none hover:outline-4 hover:outline-blue-400 transition-colors"
          >
            Edit Article
          </Link>
        </div>
